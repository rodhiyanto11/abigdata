        ...
        methods : {
              ...
              console.log(role_data);
                ...
                if(role_data.length == 0 ){
                  ...
                  if(this.$parent.search.length > 0){
                    axios.get('/api/userroles?req=userrole&id='+role_data.id+'&key='+this.$parent.search)
                    .then (({data}) => this.dataroles = data)
                  }else{
                    axios.get('/api/userroles?req=userrole&id='+role_data.id)
                    .then (({data}) => this.dataroles = data)
                  }
          ...
          deleterolepage: function(id){
            swal.fire({
                ...
                if (result.value) {
                  this.$Progress.start();
                  this.form.delete('/api/userroles/'+id)
                  .then((response) => {
